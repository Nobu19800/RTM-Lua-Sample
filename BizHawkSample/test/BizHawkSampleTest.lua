...
local bizhawksampletest_spec = {["implementation_id"]="BizHawkSampleTest", 
		 ["type_name"[="BizHawkSampleTest", 
...
-- @class BizHawkSampleTest
-- @brief BizHawk Sample
--
-- BizHawk上でRTCを動作させるためのサンプル
local BizHawkSampleTest = {}
BizHawkSampleTest.new = function(manager)
	local obj = {}
...
local MyModuleInit = function(manager)
    BizHawkSampleTest.Init(manager)

    -- Create a component
    local comp = manager:createComponent("BizHawkSampleTest")
end
