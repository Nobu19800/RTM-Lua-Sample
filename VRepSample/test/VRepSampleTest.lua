...
local vrepsampletest_spec = {["implementation_id"]="VRepSampleTest", 
		 ["type_name"[="VRepSampleTest", 
...
-- @class VRepSampleTest
-- @brief V-REP Sample
--
-- V-REP上でRTCを動作させるためのサンプル
local VRepSampleTest = {}
VRepSampleTest.new = function(manager)
	local obj = {}
...
local MyModuleInit = function(manager)
    VRepSampleTest.Init(manager)

    -- Create a component
    local comp = manager:createComponent("VRepSampleTest")
end
