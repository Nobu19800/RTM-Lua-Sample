...
local lovesampletest_spec = {["implementation_id"]="LOVESampleTest", 
		 ["type_name"[="LOVESampleTest", 
...
-- @class LOVESampleTest
-- @brief LOVE2D Sample
--
-- LÖVE上でRTCを動作させるためのサンプル
local LOVESampleTest = {}
LOVESampleTest.new = function(manager)
	local obj = {}
...
local MyModuleInit = function(manager)
    LOVESampleTest.Init(manager)

    -- Create a component
    local comp = manager:createComponent("LOVESampleTest")
end
