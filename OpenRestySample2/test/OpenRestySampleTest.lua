...
local openrestysampletest_spec = {["implementation_id"]="OpenRestySampleTest", 
		 ["type_name"[="OpenRestySampleTest", 
...
-- @class OpenRestySampleTest
-- @brief OpenResty Sample Component
--
-- OpenResty上で動作するRTC
local OpenRestySampleTest = {}
OpenRestySampleTest.new = function(manager)
	local obj = {}
...
local MyModuleInit = function(manager)
    OpenRestySampleTest.Init(manager)

    -- Create a component
    local comp = manager:createComponent("OpenRestySampleTest")
end
