...
local coppeliasimsampletest_spec = {["implementation_id"]="CoppeliaSimSampleTest", 
		 ["type_name"[="CoppeliaSimSampleTest", 
...
-- @class CoppeliaSimSampleTest
-- @brief CoppeliaSim RTC Example
local CoppeliaSimSampleTest = {}
CoppeliaSimSampleTest.new = function(manager)
	local obj = {}
...
local MyModuleInit = function(manager)
    CoppeliaSimSampleTest.Init(manager)

    -- Create a component
    local comp = manager:createComponent("CoppeliaSimSampleTest")
end
