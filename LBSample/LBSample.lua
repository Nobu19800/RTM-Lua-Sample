...
-- This module's spesification
-- <rtc-template block="module_spec">
local lbsample_spec = {["implementation_id"]="LBSample",
		 ["type_name"]="LBSample",
...
LBSample.Init = function(manager)
    local profile = openrtm.Properties.new{defaults_map=lbsample_spec}
...
local MyModuleInit = function(manager)
    LBSample.Init(manager)

    -- Create a component
    local comp = manager:createComponent("LBSample")
end
